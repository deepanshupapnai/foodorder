            ...
            <form action="#" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="food-menu-img">
                        <img src="images/vpizza.jpg" alt="Veg Pizza" class="img-responsive img-curve">
                    </div>
                    ...
                    <div class="food-menu-desc">
                        ...
                        <h3>Veg Pizza</h3>
                        <p class="food-price">Rs.199 - Rs.499</p>
                ...
                <fieldset>
                    ...
                    <div class ="order-label">Item</div>
                            ...
                            <option value = "Margherita">Margherita      = Rs.199</option>
                            <option value = "OnionGarlic">Onion-Garlic     = Rs.359 </option>
                            <option value = "Cheese">Cheese              = Rs.499 </option>
