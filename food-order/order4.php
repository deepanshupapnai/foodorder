            ...
            <form action="#" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="food-menu-img">
                        <img src="images/burger.jpg" alt="Non-Veg Burger" class="img-responsive img-curve">
                    </div>
                    ...
                    <div class="food-menu-desc">
                        ...
                        <p class="food-price">Rs.159 - Rs.299</p>
                ...
                <fieldset>
                    ...
                    <div class ="order-label">Item</div>
                            ...
                            <option value = "Egg-Burger ">Egg-Burger             = Rs.159</option>
                            <option value = "Chicken-Burger ">Chicken-Burger     = Rs.199 </option>
                            <option value = "Mutton-Burger">Mutton-Burger        = Rs.299 </option>
