            ...
            <form action="#" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="food-menu-img">
                        <img src="images/nmomo.jpg" alt="Non-Veg Momos" class="img-responsive img-curve">
                    </div>
                    ...
                    <div class="food-menu-desc">
                        ...
                        <h3>Non-Veg Momos</h3>
                        <p class="food-price">Rs.150 - Rs.250</p>
                ...
                <fieldset>
                    ...
                    <div class ="order-label">Item</div>
                            ...
                            <option value = "ChikenMomos ">Chiken-Momos             = Rs.150</option>
                            <option value = "ChikenFriedMomos">Chiken-Fried-Momos   = Rs.200 </option>
                            <option value = "MuttonMomos">Mutton-Momos              = Rs.250 </option>
