            ...
            <form action="#" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="food-menu-img">
                        <img src="images/npizza.jpg" alt="Non-Veg Pizza" class="img-responsive img-curve">
                    </div>
                    ...
                    <div class="food-menu-desc">
                        ...
                        <h3>Non-Veg Pizza</h3>
                        <p class="food-price">Rs.299 - Rs.699</p>
                ...
                <fieldset>
                    ...
                    <div class ="order-label">Item</div>
                            ...
                            <option value = "Chickentop">Chicken-top         = Rs.299</option>
                            <option value = "Chickenfreak">Chicken-freak     = Rs.499 </option>
                            <option value = "MuttonMushroom">Mutton-Mushroom = Rs.699 </option>
