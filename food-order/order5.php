            ...
            <form action="#" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="food-menu-img">
                        <img src="images/menu-momo.jpg" alt="Veg Momos" class="img-responsive img-curve">
                    </div>
                    ...
                    <div class="food-menu-desc">
                        ...
                        <h3>Veg Momos</h3>
                        <p class="food-price">Rs.100 - Rs.200</p>
                ...
                <fieldset>
                    ...
                    <div class ="order-label">Item</div>
                            ...
                            <option value = "Steam-Momos">Steam-Momos             = Rs.100</option>
                            <option value = "Fried-Momos">Fried-Momos             = Rs.150 </option>
                            <option value = "Tandoori-Momos">Tandoori-Momos       = Rs.200 </option>
